...
export const PRODUCTS = [
  ...
  },
  {
    ...
    mockups: { base: "mug", ext: "jpg", colors: ["white"] },
    image: "/images/mug.jpg",
    gallery: [{ src: "/images/mug.jpg", label: "Mug" }],
    printAreas: SINGLE({ left: 33, top: 35, width: 34, height: 33 }, { w: 8, h: 3.5 }, "Wrap"),
  ...
  },
  {
    ...
    printingOptions: FULL_COLOUR,
    mockups: { base: "frame", ext: "jpg", colors: ["white", "black"] },
    image: "/images/frame.jpg",
    gallery: [{ src: "/images/frame.jpg", label: "Frame" }],
    printAreas: SINGLE({ left: 35, top: 24, width: 30, height: 42 }, { w: 8.3, h: 11.7 }),
  ...
  },
  {
    ...
    printingOptions: FULL_COLOUR,
    mockups: { base: "cushion", ext: "jpg", colors: ["white"] },
    image: "/images/cushion.jpg",
    gallery: [{ src: "/images/cushion.jpg", label: "Cushion" }],
    printAreas: SINGLE({ left: 31, top: 27, width: 38, height: 38 }, { w: 14, h: 14 }),
  ...
  },
  {
    ...
    printingOptions: FULL_COLOUR,
    mockups: { base: "canvas", ext: "jpg", colors: ["white"] },
    image: "/images/canvas.jpg",
    gallery: [{ src: "/images/canvas.jpg", label: "Canvas" }],
    printAreas: SINGLE({ left: 31.5, top: 21, width: 39, height: 54 }, { w: 12, h: 18 }),
  ...
  },
  {
    ...
    printingOptions: FULL_COLOUR,
    mockups: { base: "keychain", ext: "jpg", colors: ["white"] },
    image: "/images/keychain.jpg",
    gallery: [{ src: "/images/keychain.jpg", label: "Keychain" }],
    printAreas: SINGLE({ left: 39.5, top: 35.5, width: 21, height: 28 }, { w: 1.2, h: 2 }),
  ...
  },
  {
    ...
    printAreas: SINGLE({ left: 33, top: 35, width: 34, height: 33 }, { w: 7, h: 3 }, "Wrap"),
